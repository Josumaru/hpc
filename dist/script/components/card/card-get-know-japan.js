  ...
  render() {
    ...
    <div class="relative h-[421px] select-none cursor-pointer" id="card">
      ...
      >
        ...
        >
          <p class="text-lg sm:text-2xl xl:text-3xl
          font-medium">${this.getAttribute("title")}</p>
          <svg
        ...
        <p
          class="absolute bottom-3 left-1/2 w-full -translate-x-1/2 px-2
          sm:px-7 xl:px-10 pt-8 text-center text-base xl:text-lg opacity-0
