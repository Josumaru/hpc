class TouristSlider extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
         <div class="container mt-14 flex md:flex-row flex-col
         items-center justify-center gap-5 md:gap-12 lg:gap-16">
          <div class="flex-1">
            <img
            ...
            <h1 class="pt-1 text-4xl md:text-[45px] lg:text-[50px]
            font-bold leading-tight" id="destination">
                TSUHIMA ISLAND
            </h1>
            <p class="py-5 md:py-8 text-sm md:text-base xl:text-lg
          ...
          <div class="swiper mySwiper w-[250px] sm:w-[300px]
          md:w-[380px] h-[420px] md:h-[540px] lg:w-[550px] xl:w-[650px]
          2xl:w-[768px]">
